        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    @if(! auth()->user()->isSuperAdmin() && auth()->user()->activeMembership()?->role !== 'app_admin' && auth()->user()->can('reports.view'))
            ...
            <flux:sidebar.nav>
                <flux:sidebar.item icon="folder-git-2" href="https://github.com/stephenprasetyachrismawan/WareHouse-Koperasi" target="_blank">
                    {{ __('Repository') }}
                </flux:sidebar.item>
