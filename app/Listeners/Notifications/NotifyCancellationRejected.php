...
class NotifyCancellationRejected
{
    public function __construct(
        private readonly CreateInboxNotificationAction $createNotification,
    ) {}

    public function handle(CancellationRejected $event): void
    {
        try {
            ...
            $this->createNotification->execute(new CreateInboxNotificationInput(
                ...
                message: "Permintaan pembatalan Purchase Request {$cancellationRequest->purchaseRequest->request_number} ditolak.",
            ...
            Log::error('Failed to create cancellation-rejected notification.', [
